...
// ---- Register form (inner, needs auth context) -----------------------------
  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-navy cosmic-bg relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-40 -left-40 h-80 w-80 rounded-full bg-accent-purple/5 blur-3xl" />
        <div className="absolute -bottom-40 -right-40 h-80 w-80 rounded-full bg-accent-blue/5 blur-3xl" />
        <div className="absolute bottom-1/4 right-1/3 h-60 w-60 rounded-full bg-accent-emerald/3 blur-3xl" />
      </div>
      ...
      <div className="relative z-10 w-full max-w-md px-6 py-12">
        ...
        <div className="rounded-2xl border border-border bg-surface/80 backdrop-blur-sm p-8 shadow-2xl shadow-black/30">
          ...
          <p className="mb-6 text-sm text-text-muted">
            Get started with all 45 methodologies
          </p>
